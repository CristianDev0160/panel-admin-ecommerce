...
const settingsDev: SettingsCardType[] = [
  {
    heading: "API Key Management",
    description: "Crea y gestiona tus API keys",
    icon: KeyIcon,
  ...
  },
  {
    ...
    description: "Gestionar los motivos de los artículos devueltos",
    icon: ArrowUTurnLeft,
    to: "/a/settings/return-reasons",
  },
];

const settingsAdmin: SettingsCardType[] = [
  {
    heading: "Divisas",
    description: "Gestionar las divisas de tu tienda",
    icon: CoinsIcon,
    to: "/a/settings/currencies",
  },
  {
    heading: "Regiones",
    description: "Gestionar el envío, págos, and entregas por regiones",
    icon: MapPinIcon,
    to: "/a/settings/regions",
  },
  {
    heading: "Impuestos",
    description: "Gestionar impuestos en todas las regiones y productos",
    icon: TaxesIcon,
    to: "/a/settings/taxes",
  },
  {
    heading: "Equipo",
    description: "Gestiona los usuarios de E-commerce Poolex",
    icon: UsersIcon,
    to: "/a/settings/team",
  },
];
...
const settings: SettingsCardType[] = [
  {
    ...
    description: "Gestiona tu perfil de E-commerce Poolex",
    icon: HappyIcon,
    to: "/a/settings/personal-information",
  },
  {
    heading: "Detalles de la tienda",
    description: "Gestiona los datos de tu tienda",
    icon: CrosshairIcon,
    ...
    <div className="gap-y-xlarge flex flex-col">
      <div className="gap-y-large flex flex-col">
        ...
        <div className="medium:grid-cols-2 gap-y-xsmall grid grid-cols-1 gap-x-4">
          ...
          {user?.role === "admin" && settingsAdmin.map((s) => renderCard(s))}
          {user?.role === "developer" && settingsDev.map((s) => renderCard(s))}
        </div>
      </div>
